...
export default function Home() {
    return (
        <div className={"max-w-7xl overflow-hidden rounded-xl p-8 text-slate-700"}>
            ...
            <p className={"my-2 font-semibold"}>Sie haben einen Anspruch auf Einbürgerung, wenn folgende Voraussetzungen vorliegen:</p>
            ...
            <p className={"text-sm my-4"}>
                Einzelheiten hierzu finden Sie in der Broschüre der Beauftragten der Bundesregierung für Migration, Flüchtlinge und Integration: <a
                className={"font-semibold underline cursor-pointer "}
                rel={"noreferrer"}
                target={"_blank"}
                href="https://www.bmi.bund.de/SharedDocs/downloads/DE/publikationen/themen/heimat-integration/wege-zur-einbuergerung.html">&quot;Wege zur Einbürgerung&quot;</a>.
            </p>
            ...
            <p>Durch die erfolgreiche Teilnahme am Einbürgerungstest können Sie Kenntnisse der Rechts- und Gesellschaftsordnung und der Lebensverhältnisse in Deutschland nachweisen, die Sie benötigen, um sich in Deutschland einbürgern zu lassen.
<br/>
...
<br/>
            ...
            <p>
                ...
                <ul className={"list-disc list-inside flex flex-col space-y-4"}>
                    ...
                    <li>Sie können die Anforderungen wegen einer körperlichen, geistigen oder seelischen Krankheit, einer Behinderung oder altersbedingt nicht erfüllen.</li>
                </ul>
            </p>
            ...
            <div>
                Quelle: <a rel={"noreferrer"} target={"_blank"} href={"https://www.bamf.de/DE/Themen/Integration/ZugewanderteTeilnehmende/Einbuergerung/einbuergerung-node.html#a_284306_0"}>BAMF: Einbürgerung in Deutschland (07.02.2023)</a>
            </div>
        </div>
    )
}
